# -*- eval: (add-hook 'after-save-hook 'org-babel-tangle nil t); eval: (add-hook 'after-save-hook (lambda () (chmod "~/.config/river/init" #o754)) nil t); -*-
...
#+STARTUP: fold
#+OPTIONS: toc:2
#+PROPERTY: header-args:shell :tangle ~/.config/river/init :results silent :session riversession
