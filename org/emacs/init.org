...
(use-package elfeed
  ...
  :config
  (setq elfeed-feeds
        '(("https://voidlinux.org/atom.xml" linux)
          ("https://karthinks.com/index.xml" emacs)
          ;; ("https://anchor.fm/s/149fd51c/podcast/rss" entertainment linux)
          ("https://xkcd.com/atom.xml" entertainment))))
#+end_src
** sage
#+begin_src emacs-lisp :tangle no
...
;; (defun append-semicolon (&optional n)
;;     (interactive "p")
;;     (use-region-p))
