...
("website-pages"
 :base-directory "~/code/web/org/"
 :base-extension "org"
 :publishing-directory "~/code/web/html/"
 :recursive t
...
(setq org-capture-templates
      '(("t" "Todo" entry (file+headline "~/org/gtd.org" "Tasks")
         "* TODO %?\n  %i\n  %a")
        ("a" "Job Application" entry (file+headline "~/org/applications/applications.org" "Applied")
         "** %?\nApplied on %U\n  %i\n  %a")
        ("s" "s[mart|puid] ideas" entry (file "~/org/ideas.org")
         "** %^{idea:}\n%?\n")
        ("w" "Website" entry (file+datetree "~/org/websites.org")
         "** %:annotation\n\n%i")
...
(defvar-keymap ss/toggle-map  :doc "Keymap for toggling things"
  ...
  "t" '("transparency" . (lambda () (interactive) (set-frame-parameter nil 'alpha-background (if (= 100 (frame-parameter nil 'alpha-background)) 80 100))))
...
(evil-define-key '(normal visual) 'global (kbd "<leader>") (cons "Leader"  ss/leader-map))
#+end_src
** Text Objects
#+begin_src emacs-lisp
...
(evil-define-key 'normal Info-mode-map (kbd "C-SPC") 'Info-scroll-up)
